...
import mdRaw from '../../Docs_catjav/01_resumen_catjav.md?raw'
...
export default function Resumen() {
  ...
  if (firstHeadingIndex !== -1) {
    ...
    // remove only the first heading line to avoid duplicate title
            ...
            components={{
              ...
              code: ({inline, className, children, ...props}) => (
                inline ? (
                  ...
                  <pre className="bg-gray-900 text-white rounded-md p-3 overflow-x-auto" {...props}><code className={className}>{children}</code></pre>
                )
              )
            }}
          >
