...
const ControlCard = ({ icon, title, subtitle, children }) => (
    ...
    <div className="max-w-4xl mx-auto p-6">
      <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl shadow-lg p-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
          <ControlCard icon={<span className="w-6 h-6 text-sky-600" aria-hidden>🛡️</span>} title="SQL Injection" subtitle="Prepared statements, WAF, mínimos privilegios">
            Previene la ejecución de consultas SQL maliciosas y reduce el impacto sobre los datos.
          </ControlCard>

          <ControlCard icon={<span className="w-6 h-6 text-sky-600" aria-hidden>🔒</span>} title="Cross-Site Scripting (XSS)" subtitle="CSP, sanitización, cookies seguras">
            Reduce la posibilidad de ejecución de código en el navegador y protege sesiones.
          </ControlCard>

          <ControlCard icon={<span className="w-6 h-6 text-sky-600" aria-hidden>⚠️</span>} title="Command Injection" subtitle="Validación, cuentas con mínimos privilegios, EDR">
        ...
        <div className="mt-6 grid grid-cols-2 gap-3">
          <div className="p-4 border rounded-lg bg-gray-50 dark:bg-gray-800">
            <div className="flex items-center gap-2 mb-2"><span className="w-5 h-5 text-indigo-600" aria-hidden>🗄️</span><strong>Control: Base de Datos</strong></div>
          ...
          <div className="p-4 border rounded-lg bg-gray-50 dark:bg-gray-800">
            <div className="flex items-center gap-2 mb-2"><span className="w-5 h-5 text-amber-600" aria-hidden>🔑</span><strong>Control: Gestión de credenciales</strong></div>
